<#--noinspection HtmlUnknownTarget,HtmlRequiredAltAttribute,HtmlUnknownAttribute,JSUnnecessarySemicolon,HtmlUnknownAnchorTarget,SpellCheckingInspection-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>产品详情页</title>
    <link rel="icon" href="ico/bitbug_favicon.ico">
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <label>
                                        <input autocomplete="off" type="text" minnum="1" ng-model="num"
                                               class="itxt"/>
                                    </label>
                    ...
                    <div class="good-suits">
                        ...
                        <div class="fl suits">
                            <ul class="suit-list">
                                ...
                                <li class="">
                                    <div id="img1"><img src="img/_/dp02.png"/></div>
                                    <i>Feless费勒斯VR</i>
                                    <label data-toggle="checkbox" class="checkbox-pretty">
                                ...
                                <li class="">
                                    <div id=img2"><img src="img/_/dp03.png"/></div>
                                    <i>Feless费勒斯VR</i>
                                    <label data-toggle="checkbox" class="checkbox-pretty">
                                ...
                                <li class="">
                                    <div id="img3"><img src="img/_/dp04.png"/></div>
                                    <i>Feless费勒斯VR</i>
                                    <label data-toggle="checkbox" class="checkbox-pretty">
